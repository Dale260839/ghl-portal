...
export function mapProject(record: GhlRecord): Project {
  ...
  ownerAuthProfileId: str(record, 'auth_profile_id'),
    ...
    showDocuments: bool(record, 'show_documents'),
    showPhotos: bool(record, 'show_photos'),
    showDailyUpdates: bool(record, 'show_daily_updates'),
    showChangeOrders: bool(record, 'show_change_orders'),
