...
export const SCREENS = {
  ...
  dashboard: {
    ...
    blocks: [
      ...
      { id: 'nav-pipeline', label: "Pipeline", kind: 'nav', col: [1, 3], row: [4, 1] },
      { id: 'nav-projects', label: "Projects", kind: 'nav', col: [1, 3], row: [5, 1] },
      { id: 'nav-field-updates', label: "Field Updates", kind: 'nav', col: [1, 3], row: [6, 1] },
      { id: 'nav-issues', label: "Issues", kind: 'nav', col: [1, 3], row: [7, 1] },
      { id: 'nav-from-buildsuite', label: "From BuildSuite", kind: 'nav', col: [1, 3], row: [8, 1] },
  ...
  pipeline: {
    ...
    blocks: [
      ...
      { id: 'nav-issues', label: "Issues", kind: 'nav', col: [1, 3], row: [7, 1] },
      { id: 'nav-from-buildsuite', label: "From BuildSuite", kind: 'nav', col: [1, 3], row: [8, 1] },
      { id: 'title', label: "Pipeline", kind: 'header', col: [4, 9], row: [3, 1] },
      { id: 'sec-where-deals-are-now', label: "Where deals are now", kind: 'panel', col: [4, 9], row: [4, 2] },
      { id: 'sec-how-far-the-pipeline-gets', label: "How far the pipeline gets", kind: 'panel', col: [4, 9], row: [6, 2] },
      { id: 'sec-deals', label: "Deals", kind: 'panel', col: [4, 9], row: [8, 2] },
    ],
  },
  ...
  project: {
    ...
    blocks: [
      ...
      { id: 'nav-issues', label: "Issues", kind: 'nav', col: [1, 3], row: [7, 1] },
      { id: 'nav-from-buildsuite', label: "From BuildSuite", kind: 'nav', col: [1, 3], row: [8, 1] },
      { id: 'title', label: "john home", kind: 'header', col: [4, 9], row: [3, 1] },
  ...
  updates: {
    ...
    blocks: [
      ...
      { id: 'sec-published-to-clients', label: "Published to clients", kind: 'panel', col: [4, 9], row: [4, 2] },
    ],
  },
  ...
  field: {
    ...
    blocks: [
      ...
      { id: 'sec-my-projects', label: "My projects", kind: 'panel', col: [4, 6], row: [4, 2] },
    ],
  },
