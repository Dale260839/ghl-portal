...
--
-- The architecture (§1.2) has GoHighLevel owning milestones, tasks, updates and
-- the rest after handoff. GHL custom objects are not reachable yet — we have a
-- private integration key but no object key — and the client needs to see these
-- screens now. Storing them here removes that dependency.
--
-- If GHL custom objects later become the system of record, these tables become
-- the migration source rather than wasted work. Recorded as D-014.
-- ============================================================================
